...
class FeedbackImpl : public hardware::Feedback, public rclcpp::Node {
  ...
  rclcpp::Subscription<std_msgs::msg::Float32MultiArray>::SharedPtr m_drive_pid_sub;
  ...
  rclcpp::Publisher<std_msgs::msg::Float32MultiArray>::SharedPtr m_drive_motor_data_pub;
  rclcpp::Publisher<std_msgs::msg::Float32MultiArray>::SharedPtr m_drive_imu_data_pub;
  rclcpp::Publisher<std_msgs::msg::Float32MultiArray>::SharedPtr m_drive_pid_data_pub;
